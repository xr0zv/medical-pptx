...
1. **Title slide** (15 seconds): Title + [Author]
...
6. **Closing** (30 seconds): "Thank You / Questions & Discussion"
...
8. **Closing** (15 seconds): "Thank You / Questions & Discussion"
...
10. **Closing** (30 seconds): "Thank You / Questions & Discussion"
...
8. **Closing** (1 minute): "Thank You / Questions & Discussion"
...
- **Clear, specific title** (not generic) — large and prominent
- **[Author]** — smaller text at the bottom of the slide
- **No subtitle, institution, credentials, affiliation, date, or venue** — keep the title slide clean with only title and author
- **Optional**: Compelling background image or color related to the topic
...
If the talk warrants an acknowledgments slide, place it before the final slide. Keep brief (15-30 seconds max):
...
Your final slide stays visible during Q&A. Keep it clean and simple:
- **"Thank You"** — large, prominent text
- **"Questions & Discussion"** — subtitle underneath
- **No contact info, references, source material, or other text** — the slide should be visually clean

Avoid ending with references, contact details, or dense acknowledgments — these clutter the slide and don't facilitate discussion.
...
- [ ] Final slide is clean "Thank You / Questions & Discussion" only
